(SELECT '2018' AS year,
 	'01' AS month,
 	`start station id`, `start station name`, `start station latitude`, `start station longitude`, COUNT(*) AS num_trips 
FROM `201801-citibike-tripdata`
GROUP BY `start station id`, `start station name`, `start station latitude`, `start station longitude`) 
