SELECT DISTINCT `start station latitude` AS latitude, `start station longitude` AS longitude
FROM
(
...
SELECT DISTINCT `end station latitude` AS latitude, `end station longitude` AS longitude
FROM
(
SELECT DISTINCT `end station latitude`, `end station longitude`
FROM `201801-citibike-tripdata`
